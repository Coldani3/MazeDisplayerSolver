...
{
public:
    NeuralNetworkSolver(std::shared_ptr<Maze> maze, std::shared_ptr<MazePathManager> pathManager, int maxNetworkGroups, int networksPerGroup, int maxLayersPerNetwork, int trainsPerCycle);
    ~NeuralNetworkSolver();
    void solve();
